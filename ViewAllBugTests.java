...
public class ViewAllBugTests {
    ...
    public void updateBugStatusTest () {
        ...
        Response responseUpdateBug = RestAssured
                ...
                .contentType("application/x-www-form-urlencoded")
                .cookies(cookies)
                .body("bug_id=" + bugId + "&last_updated=1536986793&category_id=1&view_state=10&handler_id=0&priority=30&severity=50&reproducibility=70&status=50&resolution=10&platform=&os=&os_build=&summary=%D1%82%D0%B5%D0%BC%D0%B0&description=%D0%BE%D0%BF%D0%B8%D1%81%D0%B0%D0%BD%D0%B8%D0%B5&steps_to_reproduce=&additional_information=&bugnote_text=")
